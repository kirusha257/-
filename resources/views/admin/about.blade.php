...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box;}
        ...
        textarea{background:var(--bg-input);border:1px solid var(--border);border-radius:var(--radius-sm);padding:14px;color:var(--text);font-family:'DM Sans',sans-serif;font-size:0.9rem;width:100%;resize:vertical;min-height:280px;outline:none;line-height:1.7;transition:border-color 0.2s;}
        textarea:focus{border-color:var(--border-gold);box-shadow:0 0 0 3px rgba(201,168,76,0.07);}
        ...
        <div class="card">
            <form method="POST" action="{{ route('admin.about.update') }}">
                ...
                <div class="field">
                    ...
                    <textarea name="content">{{ $about->content ?? '' }}</textarea>
