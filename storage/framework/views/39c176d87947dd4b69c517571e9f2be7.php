...
<head>
    ...
    <title><?php echo e(__('messages.vkucno_events')); ?></title>
    <style>
...
<main class="container">
    ...
    <section id="upcoming">
        <h2 class="section-title"><?php echo e(__('messages.upcoming_events')); ?></h2>
                ...
                <?php $__currentLoopData = $upcomingEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="event-card">
                        <?php if($event->photo_url): ?>
                            <img src="<?php echo e($event->photo_url); ?>" alt="<?php echo e($event->title); ?>" class="event-photo">
                        <?php else: ?>
                            <img src="https://placehold.co/400x220?text=Нет+фото" alt="Нет фото" class="event-photo">
                        <?php endif; ?>
                        <div class="event-content">
                            <div class="event-date"><?php echo e(\Carbon\Carbon::parse($event->date)->format('d.m.Y')); ?>

                                <?php if($event->start_time): ?>
                                    <span style="margin-left: 10px;">🕐 <?php echo e(\Carbon\Carbon::parse($event->start_time)->format('H:i')); ?></span>
                                <?php endif; ?>
                            </div>
                            <h3 class="event-title"><?php echo e(app()->getLocale() === 'en'
                                ? ($event->title_en ?? $event->title)
                                : $event->title); ?></h3>
                            <p class="event-description"><?php echo e(app()->getLocale() === 'en'
                                ? ($event->short_description_en ?? $event->short_description)
                                : $event->short_description); ?></p>
                            <a href="#" class="event-link"
   data-title="<?php echo e(e(app()->getLocale() === 'en' ? ($event->title_en ?? $event->title) : $event->title)); ?>"
   data-description="<?php echo e(e(app()->getLocale() === 'en' ? ($event->full_description_en ?? $event->short_description_en ?? $event->full_description ?? $event->short_description) : ($event->full_description ?? $event->short_description))); ?>"
   data-date="<?php echo e(e(\Carbon\Carbon::parse($event->date)->format('d.m.Y') . ($event->start_time ? ' в ' . \Carbon\Carbon::parse($event->start_time)->format('H:i') : ''))); ?>"
   onclick="showEventDetails(this); return false;">Подробнее →</a>
    ...
    <section id="past" class="past-section">
        <h2 class="section-title"><?php echo e(__('messages.past_events')); ?></h2>
...
</html><?php /**PATH C:\Users\pomer\projects\web\WEB\resources\views/events.blade.php ENDPATH**/ ?>