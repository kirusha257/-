...
<body>
    <div class="page-wrap">
        ...
        <div class="card">
            <form method="POST" action="<?php echo e(route('admin.about.update')); ?>" id="aboutForm">
                <?php echo csrf_field(); ?>
                <div class="field">
                    <label class="field__label">Текст раздела "О нас"</label>
                    <textarea name="content" id="editor"><?php echo e($about->content ?? ''); ?></textarea>
...
</html><?php /**PATH C:\Users\pomer\projects\web\WEB\resources\views/admin/about.blade.php ENDPATH**/ ?>