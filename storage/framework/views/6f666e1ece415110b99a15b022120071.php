...
<head>
    ...
    <title><?php echo e(__('messages.vkucno_booking')); ?></title>
    <style>
...
<main class="container">
    <div class="booking-section">
        <h1 class="section-title"><?php echo e(__('messages.booking')); ?></h1>
        ...
        <form method="POST" action="<?php echo e(route('booking.store')); ?>">
            ...
            <div class="form-group">
                <label><?php echo e(__('messages.Guests_name')); ?> <span class="required">*</span></label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label><?php echo e(__('messages.Contact phone number')); ?><span class="required">*</span></label>
                <input type="tel" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="+7 (___) ___-__-__" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label><?php echo e(__('messages.E-mail address')); ?></label>
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="example@mail.ru">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label><?php echo e(__('messages.Desired date')); ?><span class="required">*</span></label>
                <input type="date" name="date" value="<?php echo e(old('date')); ?>" min="<?php echo e(date('Y-m-d')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label><?php echo e(__('messages.Desired time')); ?><span class="required">*</span></label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label><?php echo e(__('messages.Number of guests')); ?><span class="required">*</span></label>
                <select name="guests_count" required>
                    <option value=""><?php echo e(__('messages.Select the quantity')); ?></option>
                    <?php for($i = 1; $i <= 10; $i++): ?>
                        <option value="<?php echo e($i); ?>" <?php echo e(old('guests_count') == $i ? 'selected' : ''); ?>>
                            <?php echo e($i); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group checkbox-group">
                ...
                <label for="privacy_consent"><?php echo e(__('messages.personal data')); ?><span class="required">*</span></label>
            </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <button type="submit" id="submitBtn" class="btn-submit"><?php echo e(__('messages.to_book')); ?></button>
        </form>
    </div>
</main>
...
</html><?php /**PATH C:\Users\pomer\projects\web\WEB\resources\views/booking.blade.php ENDPATH**/ ?>