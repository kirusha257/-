...
<body>
    ...
    <?php if($isSuperAdmin): ?>
        <a href="<?php echo e(route('admin.about')); ?>" class="menu-card">
            <div class="menu-card__icon">📝</div>
            <div class="menu-card__label">О нас</div>
            <div class="menu-card__arrow">›</div>
        </a>
        <a href="<?php echo e(route('admin.staff')); ?>" class="menu-card">
            <div class="menu-card__icon">👥</div>
            <div class="menu-card__label">Персонал</div>
            <div class="menu-card__arrow">›</div>
        </a>
        <a href="<?php echo e(route('admin.reviews')); ?>" class="menu-card">
            <div class="menu-card__icon">⭐</div>
            <div class="menu-card__label">Отзывы</div>
            <div class="menu-card__arrow">›</div>
        </a>
        <a href="<?php echo e(route('admin.contacts')); ?>" class="menu-card">
            <div class="menu-card__icon">📞</div>
    ...
    <!-- Доступно всем -->
    <a href="<?php echo e(route('admin.menu')); ?>" class="menu-card">
        <div class="menu-card__icon">🍽️</div>
        <div class="menu-card__label">Меню</div>
        <div class="menu-card__arrow">›</div>
    </a>
    <a href="<?php echo e(route('admin.events')); ?>" class="menu-card">
        <div class="menu-card__icon">🎉</div>
        <div class="menu-card__label">Мероприятия</div>
        <div class="menu-card__arrow">›</div>
    </a>
    <a href="<?php echo e(route('admin.bookings')); ?>" class="menu-card">
        <div class="menu-card__icon">📅</div>
        <div class="menu-card__label">Бронирования</div>
        <div class="menu-card__arrow">›</div>
    </a>
    <a href="<?php echo e(route('admin.statistics')); ?>" class="menu-card">
        <div class="menu-card__icon">📊</div>
        <div class="menu-card__label">Статистика</div>
        <div class="menu-card__arrow">›</div>
    </a>
    <a href="<?php echo e(route('admin.gallery')); ?>" class="menu-card">
        <div class="menu-card__icon">📸</div>
        <div class="menu-card__label">Галерея</div>
        <div class="menu-card__arrow">›</div>
    </a>
    <a href="<?php echo e(route('admin.best-dishes')); ?>" class="menu-card">
        <div class="menu-card__icon">⭐</div>
    ...
    <?php if($isSuperAdmin): ?>
        <a href="<?php echo e(route('admin.admins')); ?>" class="menu-card">
            <div class="menu-card__icon">👥</div>
...
</html><?php /**PATH C:\Users\pomer\projects\web\WEB\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>